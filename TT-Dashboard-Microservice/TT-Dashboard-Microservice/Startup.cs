        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors(options =>
            {
                options.AddPolicy("ProductionPolicy",
                    builder =>
                    {
                        // TODO - add only the allowed domains to address production.
                        builder.WithOrigins("*")
                            .AllowAnyHeader()
                            .AllowAnyMethod();
                    });
            ...
            services.AddDbContext<DbContext>(options => options.UseSqlServer("Data source=ARIZONA;Initial Catalog=PM_PROD;Persist Security Info=True;User ID=PM;Password=%kENnB3L+Le"));
